...
describe('AccountMenu', () => {
  ...
  const api = (fixture: { componentInstance: unknown }): MenuApi =>
    fixture.componentInstance as MenuApi;
  ...
  it('shows the profile as a chip: initials and name', () => {
    const el = render().nativeElement as HTMLElement;
    expect(el.querySelector('.avatar')?.textContent?.trim()).toBe('LN');
